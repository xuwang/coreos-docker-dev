...
NODES_CONF = File.join(MY_PATH, "nodes-conf", "secured-cluster.json")
	...
	def config_vm(config, node_name, node_id, node_conf, index)
		config.vm.define vm_name = node_name do |config|
			...
			config.vm.provision :shell, \
				:inline => "ln -sf /home/core/share/apps /var/lib/apps && ln -sf /home/core/share/data /var/lib/apps-data", \
				:privileged => true
